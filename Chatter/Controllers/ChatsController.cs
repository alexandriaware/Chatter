...
namespace Chatter.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ChatID,UserID,MessageBox,TimeStamp")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChatID,UserID,MessageBox,TimeStamp")] Chat chat)
        {
            if (ModelState.IsValid)
            {
